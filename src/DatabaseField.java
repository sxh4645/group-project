...
public class DatabaseField {
	   ...
	   //public static final String DELIM = System.lineSeparator();
	   public static final String DELIM = "|";
	   
	   public DatabaseField(int numFigure, String name) {
	   ...
	   public String toString() {
	      /*return numFigure + System.lineSeparator() +
	      name + System.lineSeparator() +
	      tableID + System.lineSeparator() +
	      tableBound + System.lineSeparator() +
	      fieldBound + System.lineSeparator() +
	      dataType + System.lineSeparator() +
	      varcharValue + System.lineSeparator() +
	      isPrimaryKey + System.lineSeparator() +
	      disallowNull + System.lineSeparator() +
	      defaultValue;*/
	      return numFigure + DELIM +
	      name + DELIM +
	      tableID + DELIM +
	      tableBound + DELIM +
	      fieldBound + DELIM +

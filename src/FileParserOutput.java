...
public abstract class FileParserOutput implements IFileParserOutput {

   protected DatabaseTable[] tables; //master copy of EdgeTable objects
   protected DatabaseField[] fields; //master copy of EdgeField objects
   ...
   public FileParserOutput(DatabaseTable[] tables, DatabaseField[] fields) {
      this.tables = tables;
      this.fields = fields;
      initialize();
   } //EdgeConvertCreateDDL(EdgeTable[], EdgeField[])
   
   public FileParserOutput() { //default constructor with empty arg list for to allow output dir to be set before there are table and field objects
   ...
   protected DatabaseTable getTable(int numFigure) {
   ...
   protected DatabaseField getField(int numFigure) {
